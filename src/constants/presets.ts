...
export const EFFECTOR_PRESETS: EffectorPreset[] = [
  {
    ...
    inputJack: { side: 'right', position: 0.3 },
    outputJack: { side: 'left', position: 0.3 },
    color: '#4A90D9',
  },
  {
    id: 'preset-mxr-s',
  ...
  },
  {
    ...
    inputJack: { side: 'right', position: 0.15 },
    outputJack: { side: 'left', position: 0.15 },
    color: '#E67E22',
  },
  {
    ...
    inputJack: { side: 'right', position: 0.5 },
    outputJack: { side: 'left', position: 0.5 },
    color: '#8E44AD',
  },
  {
    id: 'preset-tc-mini',
